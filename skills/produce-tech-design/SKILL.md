...
go straight to step 2. Otherwise follow `../frame-design/SKILL.md` against the
...
Follow `../generate-design-doc/SKILL.md` against the **framed TD** — it
...
Follow `../check-platform-constraints/SKILL.md` against the **same TD**. It
...
Follow `../check-security-standards/SKILL.md` against the **same TD**. It
...
- **Moderate / Major** (or no accepted sizing) — follow `../threat-model/SKILL.md`
...
By default, follow `../cross-model-review/SKILL.md` against the **complete TD**:
...
`../revise-design/SKILL.md` against the comment list and the TD: it maps
