...
1. `../../atomic/generate-acceptance-tests/SKILL.md` — story's criteria → failing
   acceptance tests (the oracle); human-gated.
2. `../../atomic/generate-implementation-plan/SKILL.md` — story + tests + real code →
   the implementation plan (the human-gated contract); recommends the implementer model.
3. `../../atomic/implement-plan/SKILL.md` — dispatch the chosen (default cheaper) model
   to write code to green against the gate suite; block-and-escalate; host verifies.
4. `../../atomic/review-code/SKILL.md` — an independent fresh-context subagent reviews
...
5. `../../atomic/review-security/SKILL.md` — the **security** lens on the diff (control-cited;
...
6. `../../atomic/review-accessibility/SKILL.md` — the **accessibility** lens on the diff
...
Follow `../../atomic/review-security/SKILL.md` against the diff + the acceptance criteria +
...
Follow `../../atomic/review-accessibility/SKILL.md` against the diff + the acceptance
