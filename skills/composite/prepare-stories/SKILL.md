...
1. `../../atomic/decompose-to-stories/SKILL.md` — TD + requirements → traceable,
   Jira-ready user stories.
2. `../../atomic/check-accessibility/SKILL.md` — review the UI-facing stories against
...
Follow `../../atomic/decompose-to-stories/SKILL.md` against the TD + requirements. It
...
Follow `../../atomic/check-accessibility/SKILL.md` against the **same story set**. It
